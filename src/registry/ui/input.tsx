...
export const containerVariants = cva(
    cn(
        ...
        "data-[disabled=true]:(opacity-50 cursor-not-allowed hover:border-input)",
        ...
        variants: {
            variant: {
                ...
                faded: cn(
                    ...
                    "hover:(bg-accent border-accent) focus-within:(bg-accent border-accent) data-[disabled=true]:hover:(bg-muted border-muted)",
                ),
