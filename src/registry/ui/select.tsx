...
const selectTriggerVariants = cva(
  ...
  ),
  {
    variants: {
      ...
      size: {
        sm: "min-h-10 px-2 py-1.5 text-sm data-[placeholder]:text-sm",
        md: "min-h-12 px-2.5 py-2 text-base data-[placeholder]:text-base",
        lg: "min-h-13 p-2.5 text-lg data-[placeholder]:text-lg",
      },
    },
    compoundVariants: [
      {
