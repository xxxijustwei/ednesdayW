---
title: Cap Widget
description: A headless, shadcn-compatible React component for CAP (Captcha-Alternative Protocol) integration, providing privacy-focused, invisible CAPTCHA verification with full customization.
---

### Overview

The Cap Widget is a headless React component built for shadcn/ui that integrates [CAP (Captcha-Alternative Protocol)](https://capjs.js.org/), a modern, privacy-focused alternative to traditional CAPTCHAs. This component provides complete styling flexibility while delivering invisible verification through proof-of-work challenges that run in the background, requiring no user interaction while maintaining strong bot protection.

### Key Features

- 🎨 **Headless Design**: Fully customizable with complete control over styling and behavior
- 🔧 **shadcn Compatible**: Seamlessly integrates with shadcn/ui design system and conventions
...
- 🎯 **Theme Integration**: Automatically adapts to your design system variables
